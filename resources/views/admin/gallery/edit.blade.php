@extends('admin.include.master') 
	@section('title') Edit - {{ $gallery->name }} - ToonBD @endsection 
@section('content')
        ...
        <div class="layout-content-body">
        	<div class="col-sm-12">
                <div class="page-header">
                    <h3 class="page-title">Gallery Information Edit</h3>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}">Home</a></li>
                        <li>Settings</li>
                        <li class="active">Edit - {{ $gallery->name }}</li>
        ...
        <div class="col-sm-12">
          <div class="card">
            	<div class="row" style="margin:10px">
						...
						{!! Form::model($gallery, ['route'=>['gallery.update', $gallery->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal']) !!}
                        
                        
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('Name') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $gallery->name }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sequence" type="number" class="form-control" name="sequence" value="{{ $gallery->sequence }}" style="width:30%">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <input id="stillthumb" type="hidden" class="form-control" name="stillthumb" value="{{ $gallery->image }}">
                            </div>
                        </div>
