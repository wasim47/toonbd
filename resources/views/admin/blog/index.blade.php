@extends('admin.include.master')
	@section('title') Content List - ToonBD @endsection
@section('content')
                ...
                <div class="page-header" style="border:none">
                    <h3 class="page-title">View Content List</h3>
                        ...
                        <div class="col-sm-7 breadcrumb pull-right" style="float:right; text-align:right">
                          ...
                          <a  href="{{ route('blog.create') }}" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create New Content</a>
                      </div>
                </div>
