@extends('admin.include.master') 
	@section('title') Edit - {{ $blog->name }} - ToonBD @endsection 
@section('content')
        ...
        <div class="layout-content-body">
        	<div class="col-sm-12">
                <div class="page-header">
                    <h3 class="page-title">Content Information Edit</h3>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}">Home</a></li>
                        <li>Settings</li>
                        <li class="active">Edit - {{ $blog->name }}</li>
                         <li style="text-align:right; float:right">
                            	<a  href="{{ route('blog.index') }}" style="color:#fff;"><i class="fa fa-list"></i> View Content List</a>
                            </li>
                    </ol>
                </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            	<div class="row" style="margin:10px">
						...
						{!! Form::model($blog, ['route'=>['blog.update', $blog->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal']) !!}
                            ...
                            <div class="col-md-6">
                                <select name="cat_id" class="form-control">
                                    ...
                                    @foreach($categories as $catinfo)
                                        <option value="{{ $catinfo->slug }}">{{ $catinfo->name }}</option>
                                    @endforeach
                                </select>  
                            </div>                            
                        </div><?php */?>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('Content Headline') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('Content Details') }}</label>
                            <div class="col-md-8">
                                <textarea id="details" class="form-control ckeditor" name="details" required>{{ $blog->details }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="meta_details" type="text" class="form-control" name="meta_details" value="{{ $blog->meta_details }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sequence" type="number" class="form-control" name="sequence" value="{{ $blog->sequence }}" required style="width:30%">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <input id="stillthumb" type="hidden" class="form-control" name="stillthumb" value="{{ $blog->image }}">
                            </div>
                        </div>
