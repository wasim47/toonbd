@extends('admin.include.master') 
	@section('title') Edit - {{ $partner->name }} - ToonBD @endsection 
@section('content')
        ...
        <div class="layout-content-body">
        	<div class="col-sm-12">
                <div class="page-header">
                    <h3 class="page-title">Partner Information Edit</h3>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}">Home</a></li>
                        <li>Settings</li>
                        <li class="active">Edit - {{ $partner->name }}</li>
                         <li style="text-align:right; float:right">
                            	<a  href="{{ route('partner.index') }}" style="color:#fff;"><i class="fa fa-list"></i> View Partner List</a>
                            </li>
                    </ol>
                </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            	<div class="row" style="margin:10px">
						...
						{!! Form::model($partner, ['route'=>['partner.update', $partner->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="text" class="form-control" name="url" value="{{ $partner->url }}">
                                @if ($errors->has('url'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sequence" type="number" class="form-control" name="sequence" value="{{ $partner->sequence }}" style="width:30%">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <input id="stillthumb" type="hidden" class="form-control" name="stillthumb" value="{{ $partner->image }}">
                            </div>
                        </div>
