@extends('admin.include.master') 
	@section('title') Edit - {{ $protfolio->name }} - ToonBD @endsection 
@section('content')
        ...
        <div class="layout-content-body">
        	<div class="col-sm-12">
                <div class="page-header">
                    <h3 class="page-title">Protfolio Information Edit</h3>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}">Home</a></li>
                        <li>Settings</li>
                        <li class="active">Edit - {{ $protfolio->name }}</li>
                         <li style="text-align:right; float:right">
                            	<a  href="{{ route('protfolio.index') }}" style="color:#fff;"><i class="fa fa-list"></i> View Protfolio List</a>
                            </li>
                    </ol>
                </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            	<div class="row" style="margin:10px">
						...
						{!! Form::model($protfolio, ['route'=>['protfolio.update', $protfolio->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal']) !!}
                        
                        
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('Name') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $protfolio->name }}" required>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="text" class="form-control" name="url" value="{{ $protfolio->url }}">
                                @if ($errors->has('url'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sequence" type="number" class="form-control" name="sequence" value="{{ $protfolio->sequence }}" style="width:30%">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <input id="stillthumb" type="hidden" class="form-control" name="stillthumb" value="{{ $protfolio->image }}">
                            </div>
                        </div>
