                ...
                <div class="col-sm-12">
                  <div class="card">
                      ...
                      <div class="row" style="margin:10px">
                            <form method="POST" action="{{ route('menus.store') }}" class="form-horizontal form-label-left">
                              {{ csrf_field() }}
...
<script type="text/javascript">
	function changeUrls(thisval){
		if(thisval=='url'){
			document.getElementById('externalurl').style.display = 'inline';
		}
		else{
