@extends('admin.include.master')
	@section('title') Offer List - ToonBD @endsection
@section('content')
                ...
                <div class="page-header" style="border:none">
                    <h3 class="page-title">View Offer List</h3>
                        ...
                        <div class="col-sm-7 breadcrumb pull-right" style="float:right; text-align:right">
                          <a  href="javascript:void()" onclick="permissions('offers','1');" style="color:#000; margin-right:20px;" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Approved</a>
                          <a  href="javascript:void()" onclick="permissions('offers','0');" style="color:#000; margin-right:20px;" class="btn btn-warning btn-sm"><i class="fa fa-times"></i> Disapproved</a>
                          <a  href="javascript:void()" onclick="deletedata('masterdelete','offers');" style="color:#fff; margin-right:20px;" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Multiple Delete</a>
                          <a  href="{{ route('offer.create') }}" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create New Offer</a>
                      </div>
                </div>
                      ...
                      <div class="card-block">
                      	<form id="form_check">
                            ...
                            <tr id="tablerow<?php echo $offer->id;?>" class="tablerow">
                              ...
                              <td>{{ $offer->name }}</td>
							  <td>{{ $offer->url }}</td>							
                              <td><img src="{{ asset('uploads/offer/'.$offer->image) }}" style="width:100px; height:auto" /></td>
