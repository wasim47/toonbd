@extends('admin.include.master') 
	@section('title') Edit - {{ $admin->fullname }} - ToonBD @endsection 
@section('content')
        	...
        	<div class="col-sm-12">
                <div class="page-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Settings</li>
                        <li class="active">Edit - {{ $admin->fullname }}</li>
          ...
          <div class="card">
            	<div class="row" style="margin:10px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required value="{{ $admin->password_hints }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required value="{{ $admin->password_hints }}">
                            </div>
                        </div>
