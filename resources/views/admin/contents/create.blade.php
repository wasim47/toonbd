@extends('admin.include.master') 
	@section('title') New Article - ToonBD @endsection 
@section('content')
    ...
    <div class="col-sm-12">
      <div class="card">
          ...
          <div class="row" style="margin:10px">
                <form method="POST" action="{{ route('contents.store') }}" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
                ...
                <div class="col-md-6">
            	  ...
            	  <div class="col-sm-12" style="margin-bottom:10px;">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="title_bangla" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  </div>                              
                  <div class="col-sm-12" style="margin-bottom:10px;">
                      <div class="form-group">
                        ...
                        <div class="col-md-11 col-sm-11 col-xs-12">
                          <textarea name="content_bangla" class="form-control ckeditor"></textarea>
                        </div>
                      </div>
                </div>-->
